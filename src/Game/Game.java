...
public class Game {
	...
	/**
	 * rowSum[i] is the sum of the i-th row. Used in the computer's strategy and
	 * to determine winners.
	 */
	private int[] rowSum;

	/**
	 * colSum[i] is the sum of the i-th column. Used in the computer's strategy
	 ...
	 * the off-diagonal. Used in the computer's strategy and to determine
	 * winners.
	 */
	private int[] diagSum;
